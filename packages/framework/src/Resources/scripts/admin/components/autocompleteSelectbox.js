(function ($) {
    ...
    Selectize.prototype.positionDropdown = function () {
        ...
        // 50 is height of bottom stripe in administration
        if (this.$dropdown.offset().top + this.$dropdown.height() - $(window).scrollTop() + 50 > $(window).height()) {
